...
lst_campos = ['Coluna1','Coluna2','Coluna3','Coluna4','Coluna5','Coluna6']
...
freq_nr[0] #primeiro item
freq_nr[24] #último item

# como fazer para pegar o último item se eu não sei o tamando da lista?
#desta forma = freq_nr[-1] 
...
A combinação de Pares, Impares e Primos mais frequentes é: {} com a frequência de: {}%
